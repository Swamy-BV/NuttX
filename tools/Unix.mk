...
config:
	...
	$(Q) APPSDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) APPSBINDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) EXTERNALDIR=$(EXTERNALDIR) kconfig-conf Kconfig

oldconfig:
	$(Q) $(MAKE) clean_context
	$(Q) $(MAKE) apps_preconfig
	$(Q) APPSDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) APPSBINDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) EXTERNALDIR=$(EXTERNALDIR) kconfig-conf --oldconfig Kconfig

olddefconfig:
	$(Q) $(MAKE) clean_context
	$(Q) $(MAKE) apps_preconfig
	$(Q) APPSDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) APPSBINDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) EXTERNALDIR=$(EXTERNALDIR) kconfig-conf --olddefconfig Kconfig

menuconfig:
	$(Q) $(MAKE) clean_context
	$(Q) $(MAKE) apps_preconfig
	$(Q) APPSDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) APPSBINDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) EXTERNALDIR=$(EXTERNALDIR) kconfig-mconf Kconfig

nconfig: apps_preconfig
	$(Q) $(MAKE) clean_context
	$(Q) $(MAKE) apps_preconfig
	$(Q) APPSDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) APPSBINDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) EXTERNALDIR=$(EXTERNALDIR) kconfig-nconf Kconfig

qconfig: apps_preconfig
	$(Q) $(MAKE) clean_context
	$(Q) $(MAKE) apps_preconfig
	$(Q) APPSDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) APPSBINDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) EXTERNALDIR=$(EXTERNALDIR) kconfig-qconf Kconfig

gconfig: apps_preconfig
	$(Q) $(MAKE) clean_context
	$(Q) $(MAKE) apps_preconfig
	$(Q) APPSDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) APPSBINDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) EXTERNALDIR=$(EXTERNALDIR) kconfig-gconf Kconfig

savedefconfig: apps_preconfig
	$(Q) APPSDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) APPSBINDIR=$(patsubst "%",%,${CONFIG_APPS_DIR}) EXTERNALDIR=$(EXTERNALDIR) kconfig-conf --savedefconfig defconfig.tmp Kconfig
